  ...
  <?php print $scripts; ?>
	...
	<script type="text/javascript" >		
		jQuery(window).load(function () {		
			var space = jQuery("#header").height() + 127;			
			jQuery(".second-body").css("background-position", "center " + space + "px");	
			jQuery(".first-body").css("background-position", "center " + (space-75) + "px");
			jQuery("body").css("background-position", "center " + (space-75) + "px");
		});		
	</script>
</head>
